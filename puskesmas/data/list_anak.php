...
mysql_select_db($database_koneksi, $koneksi);
$query_RecAnak = "SELECT * FROM tabel_anak as a, tabel_ayah as b, tabel_ibu as c where a.id_ayah=b.id_ayah and a.id_ibu=c.id_ibu";
  ...
  <table width="885" border="2" cellspacing="4" cellpadding="4">
    ...
    <?php do { ?>
      <tr>
        ...
        <td><?php echo htmlentities($row_RecAnak['ttl'], ENT_COMPAT, ''); ?></td>
