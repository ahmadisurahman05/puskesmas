...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tabel_ayah (id_ayah, nama_ayah, ttl, alamat, id_pendidikan, pekerjaan, gol_darah, agama, id_ibu) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString(@$_POST['id_ibu'], "text"));
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  ...
  <table width="348" align="center">
    <tr valign="baseline">
      <td width="111" align="right" nowrap>Nama Ayah</td>
